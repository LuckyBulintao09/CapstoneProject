...
function LoginForm() {
    ...
    return (
        <div className="grid w-full gap-6">
                ...
                <form onSubmit={loginForm.handleSubmit(onSubmit)}>
                    <div className="grid gap-2">
                        ...
                        <div className="text-right text-sm">
                            <Link href="/forgot-password" className="hover:underline text-gray-700 dark:text-gray-400">
                                Forgot Password?{" "}
                            </Link>
                        </div>
            ...
            <div className="">
                <div className="border-t border-gray-300 dark:border-gray-800 pt-4 text-center text-sm">
