...
type Property = {
  ...
  company: {
    ...
    owner_id: {
      firstname: string;
      lastname: string;
      id: number; // Added for company owner ID
    };
  };
  created_at: string;
};
          ...
          <div className="grid lg:grid-cols-3 grid-cols-1 gap-4 my-6 ">
            <div className="col-span-2">
              <div className="space-y-5">
                ...
                <PropertyDetails />
                <Banner
                  ownerName={property?.company?.owner_id?.firstname}
                  ownerLastname={property?.company?.owner_id?.lastname}
                  ownerId={property?.company?.owner_id?.id}
        ...
        <div>
          ...
          <div>
            ...
            <div className="flex flex-col border-t border-gray-300 py-8 mr-4">
              ...
              <BusinessReviews propertyId={property?.id} />
            </div>
            <div className="flex flex-col border-t border-gray-300 py-8 mr-4">
              <h4 className="text-2xl font-semibold tracking-tight pb-4">
                Where you&apos;ll be
