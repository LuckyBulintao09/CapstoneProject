...
import { Marker, Circle, GoogleMap, InfoWindow } from '@react-google-maps/api';
import {
	get_allListings,
	get_nearbyInfo,
	get_nearbyListings,
...
export default function Listings() {
	...
	const fetchFilteredListings = async () => {
		try {
			...
			const fetchedListings = await get_allUnits(
				selectedLocation ?? {},
				selectedPrivacyType,
				selectedFilter,
				radius[0]
	...
	return (
		<div className='h-full'>
			<div className='flex justify-between items-center mb-4'>
				<h1 className='font-bold text-xl'>{listings.length} units found</h1>
											...
											{selectedListing && (
												...
												>
													<div>
														...
														<p>
															<b>Price: ${selectedListing.price}</b>
														</p>
