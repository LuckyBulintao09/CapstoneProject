...
function UpdatePropertyDetailsForm({ companies, propertyId, property }: { companies: any, propertyId: string, property: any }) {
    ...
    const createPropertyForm = useForm<CreatePropertyTypes>({
        ...
        defaultValues: {
            ...
            company_id: property[0].company_id.toString(),
