                    ...
                    <form onSubmit={propertiesDescriptionForm.handleSubmit(onSubmit)} className="space-y-4">
                                    ...
                                    <div className="">
                                      <FormMessage className="text-xs" />
                                        <div className="text-muted-foreground text-sm font-medium">
                                            {propertiesDescriptionForm.watch("property_description", "").length <= 500
                                                ? `${500 - propertiesDescriptionForm.watch("property_description", "").length} characters remaining`
                                                : `${propertiesDescriptionForm.watch("property_description", "").length - 500} characters over the limit`}
                                        </div>
                                        <FormControl>
                                            <div className="mt-2">
                                                <textarea
                        ...
                        <Button
                            ...
                            disabled={
                                ...
                                propertiesDescriptionForm.formState.errors.property_description !== undefined
                            }
                        >
                            {(isPending || propertiesDescriptionForm.formState.isSubmitting) && (
                                <svg
                                    aria-hidden="true"
