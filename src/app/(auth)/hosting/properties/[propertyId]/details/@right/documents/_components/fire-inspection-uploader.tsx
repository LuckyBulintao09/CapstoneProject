...
import { addPropertyFireInspection } from "@/actions/property/propertyDocuments";

import { useRouter } from "next/navigation";

function FireInstpectionUploder({ propertyId, userId }: { propertyId: string, userId: string }) {
    ...
    const handleUpload = async () => {
        if (uppy.getFiles().length > 0) {
            ...
            const objectName = `property/${userId}/${propertyId}/fire-inspection/${uppy.getFiles()[0].name}`;
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen} modal={true}>
            <DialogTrigger asChild>
                ...
                >
                    <span>Upload or update fire inspection certificate</span>
                </Button>
            </DialogTrigger>
            <DialogContent
                ...
                <DialogHeader>
                    ...
                    <DialogDescription asChild>
                        <div className="grow space-y-2">
                            <p className="">Upload your certificate here.</p>
                            <ul className="list-inside list-disc text-sm text-muted-foreground">
                                <li>Only one file allowed.</li>
                                <li>Allowed file types: .jpg, .jpeg, .png, .pdf, .doc, .docx.</li>
...
export default FireInstpectionUploder